...
void main() {
  ...
  late BumblebeePromoMarketingController controller;
  ...
  final binding = BindingsBuilder(() {
    ...
    Get.lazyReplace<BumblebeePermissionLocationController>(
  ...
  setUpAll(() async {
    ...
    binding.builder();
    controller = Get.find<BumblebeePromoMarketingController>();
    when(controller.bumblebeeSnapAndBuyBaseController.listPromoMarketingResponse)
    ...
    when(controller.bumblebeeSubmissionSectionController.realPrice)
        .thenReturn(RxInt(3000000));
  });

  tearDownAll(() {
    Get.delete<BumblebeePromoMarketingController>();
  });

  group('Test Promo Marketing Controller', () {
    test('Test Init Controller', () async {
      expect(() => Get.find<BumblebeePromoMarketingController>(tag: 'success'),
      ...
      expect(Get.isRegistered<BumblebeePromoMarketingController>(), true);
    });
    ...
    test('check valid dp should return true when is show dp is false', () {
      //arrange
      when(controller.bumblebeeSnapAndBuyBaseController.isShowDp)
    ...
    test('get snb request', () {
      ...
      when(controller.bumblebeeSnapAndBuyBaseController.prospectId)
          .thenReturn(RxString("tesProspectId"));
      when(controller.bumblebeeSubmissionSectionController.phoneNumberController)
    ...
    test('create snap and buy', (() async {
      ...
      when(controller.bumblebeeSubmissionSectionController.assetModel).thenReturn(Rx(
          AssetData(
              assetCode: "tesAssetCode",
              assetName: "tesAssetName",
              assetType: "tesAssetType",
    ...
    test('on tap tenor', (() {
      ...
      expect(controller.bumblebeeSnapAndBuyBaseController.activeSubSection.value,
    ...
    test('onChangePromo when minimum dp method is percentage', (() async {
      ...
      expect(
          ...
          (controller.bumblebeeSubmissionSectionController.realPrice.value *
    ...
    test('filter list promo', (() async {
      //arrange
      when(controller.bumblebeeSnapAndBuyBaseController.responseListProgram)
    ...
    test('select promo validation', (() {
      ...
      //act
      //assert
      expect(controller.selectPromoValidation(""), ContentConstant.emptyPromo);
