...
class ImeiWidget extends GetView<UploadPhotoImeiController> {
  @override
  ...
  Widget bodyWidget() {
    ...
    } else if (controller.listImei.isEmpty) {
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                  ContentConstant.uploadImeiWording,
                  style: TextStyle(
          ...
          Expanded(
            child: Obx(
              () => ListView.builder(
                ...
                itemCount: controller.listImei.length,
