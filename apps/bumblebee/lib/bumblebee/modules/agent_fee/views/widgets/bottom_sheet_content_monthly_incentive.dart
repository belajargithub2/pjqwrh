...
class BottomSheetContentMonthlyIncentive extends StatelessWidget {
  final Incentive data;
  final String description;

  const BottomSheetContentMonthlyIncentive({
    Key? key,
    required this.data,
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: DeasyTextView(
              text: ContentConstant.agentFeeDetailMonthlyIntencive,
              fontSize: 16.sp,
