...
import 'package:kreditplus_deasy_mobile/core/widgets/base_widget.dart';
...
class BumblebeeRegisterMerchant
    extends GetView<BumblebeeRegisterMerchantController> {
                                ...
                                child: CustomOutlineTextInputWithoutLabel(
                                  ...
                                  onFieldTap: () {
                                    SelectDialog.showModal<MerchantTypeData>(
                                      ...
                                      label: 'Tipe Merchant',
                                      onChange:
                                          (MerchantTypeData result) {
                                        controller.selectMerchantType(result.text!);
                                      },
                                      itemBuilder: (BuildContext context, MerchantTypeData item,
                                          bool isSelected) {
                                        return Container(
                                          child: ListTile(
                                            selected: isSelected,
