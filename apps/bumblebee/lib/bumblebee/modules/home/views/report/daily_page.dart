...
class DailyPage extends GetView<BumblebeeDailyPageController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<BumblebeeDailyPageController>(
      init: BumblebeeDailyPageController(),
      builder: (c) => Container(
            ...
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() => dataTable(context, c.role.value, c.rowDaily))
                  ],
                )),
          ],
        ),
  ...
  Widget dataTable(BuildContext context, String role, List<DataRow> rowDaily) {
