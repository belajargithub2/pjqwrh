...
class BumblebeeTransactionRepository {
  ...
  Future<AgentOrdersResponse> fetchApiAllAgentOrders(
    ...
    final response = await _provider.post(
        context, Scope.MERCHANT, "agents/orders", requestBody);
  ...
  Future<DetailAgentOrderResponse> fetchApiDetailAgentOrders(
    ...
    final response = await _provider.get(
        context, Scope.MERCHANT, "agents/orders/$prospectId", null);
  ...
  Future<CancelOrderResponse> putApiCancelOrder(
    ...
    final response = await _provider.put(
        context, Scope.MERCHANT, "orders/cancel", requestBody);
  ...
  Future<CancelOrderResponse> putApiAgentCancelOrder(
      BuildContext? context, Map<String, dynamic> requestBody) async {
    final response = await _provider.put(
        context, Scope.MERCHANT, "agents/orders/cancel", requestBody);
    return CancelOrderResponse.fromJson(response);
  }
  ...
  Future<CancelReasonResponse> fetchApiCancelReasonList(
      BuildContext? context, Map<String, dynamic>? requestBody) async {
    final response = await _provider.get(
        context, Scope.MERCHANT, "orders/cancel/reasons", requestBody);
  ...
  Future<CancelReasonResponse> fetchApiAgentCancelReasonList(
      BuildContext? context, Map<String, dynamic>? requestBody) async {
    final response = await _provider.get(
        context, Scope.MERCHANT, "agents/orders/cancel-reasons", requestBody);
    return CancelReasonResponse.fromJson(response);
  }

  Future<DocumentResponse> fetchApiDocumentById(BuildContext? context,
      Map<String, dynamic>? requestBody, String? prospectId) async {
    final response = await _provider.get(context, Scope.MERCHANT,
        "documents/prospect-id/$prospectId", requestBody);
    return DocumentResponse.fromJson(response);
  }

  Future<UploadDocumentResponse> postApiUploadBAST(BuildContext? context,
      Map<String, dynamic> requestBody, List<int> file) async {
  ...
  Future<UploadDocumentResponse> postApiUploadCustReceipt(BuildContext? context,
      Map<String, dynamic> requestBody, List<int> file) async {
    final response = await _provider.multipartPost(
      context,
      Scope.MERCHANT,
  ...
  Future<UploadDocumentResponse> postApiUploadImei(BuildContext? context,
      Map<String, dynamic> requestBody, List<int> file) async {
    final response = await _provider.multipartPost(
      context,
      Scope.MERCHANT,
  ...
  Future<TrackingResponse> fetchApiTracking(BuildContext? context,
      Map<String, dynamic>? requestBody, String? prospectId) async {
    final response = await _provider.get(
        context, Scope.MERCHANT, "orders/tracking/$prospectId", requestBody,
        showSnackbar: true);
  ...
  Future<PaymentDetailResponse> fetchApiPaymentDetail(
      BuildContext? context, String? prospectID) async {
    final response = await _provider.get(
        context, Scope.MERCHANT, "agreements/$prospectID", null);
  ...
  Future<Uint8List?> fetchDocument(
      ...
      String? prospectId,
      String? type) async {
    final response = await _provider.getWithoutJsonResponse(
        context, Scope.MERCHANT, "reports/$type/$prospectId/view", requestBody);
    return response;
  }

  Future<String> fetchPdfUrl({String? type, String? prospectId}) async {
    final url =
        "${flavorConfiguration!.appMerchantBaseUrlWithoutVersion}reports/$type/$prospectId/view";
    return url;
  }
}
