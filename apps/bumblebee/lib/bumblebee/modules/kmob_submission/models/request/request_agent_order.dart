...
RequestAgentOrder requestAgentOrderFromJson(String str) => RequestAgentOrder.fromJson(json.decode(str));

String requestAgentOrderToJson(RequestAgentOrder data) => json.encode(data.toJson());

class RequestAgentOrder {
  RequestAgentOrder({
    this.agentId,
    this.agentIdConfins,
    this.assets,
  ...
  factory RequestAgentOrder.fromJson(Map<String, dynamic> json) => RequestAgentOrder(
