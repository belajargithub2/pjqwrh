...
class KMOBUploadDocumentSubmissionMobileScreen
  ...
  Widget _showDialogDraft() {
    return Obx(() {
      if (controller.isShowDialogDraft.value) {
        return showDialogDraft();
      } else {
        return SizedBox();
      }
    });
  ...
  Widget _showDialogDraftSuccess() {
    return Obx(() {
      if (controller.isShowDialogDraftSuccess.value) {
        return showDialogDraftSuccess();
      } else {
        return SizedBox();
      }
    });
          ...
          content: WillPopScope(
            ...
            child: Column(
              ...
              children: [
                ...
                DeasyTextView(
                  text: ContentConstant.titleDraft,
                  fontColor: DeasyColor.neutral900,
                  maxLines: 3,
                  textAlign: TextAlign.center,
                  fontSize: DeasySizeConfigUtils.blockHorizontal! * 4.7,
                ...
                DeasyTextView(
                  text: ContentConstant.detailDraft,
                  maxLines: 3,
                  textAlign: TextAlign.center,
                  fontColor: DeasyColor.neutral400,
                ),
                ...
                Row(
                  ...
                  children: [
                    DeasyCustomElevatedButton(
                      ...
                      onPress: () {
                        Get.back();
                        controller.onTapSaveDraft(Get.context);
                      },
                    ),
                    DeasyCustomElevatedButton(
                      text: " Kembali ",
  ...
  Widget showDialogDraftSuccess() {
    controller.isShowDialogDraftSuccess.value = false;
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.defaultDialog(
          barrierDismissible: false,
          title: "",
          ...
          content: WillPopScope(
            ...
            child: Column(
              ...
              children: [
                ...
                DeasyTextView(
                  text: ContentConstant.successSaveToDraft,
                  fontColor: DeasyColor.neutral900,
                  maxLines: 3,
                  textAlign: TextAlign.center,
                  fontSize: DeasySizeConfigUtils.blockHorizontal! * 4.7,
                ...
                Container(
                  ...
                  child: DeasyCustomElevatedButton(
                    ...
                    onPress: () {
                      Get.back();
                      controller.navigateBack(isBackToHome: false);
                    },
                  ),
                ),
                SizedBox(
                ...
                Container(
                  ...
                  padding: EdgeInsets.symmetric(horizontal: 10),
                  child: DeasyCustomElevatedButton(
                    text: ContentConstant.continueToOrder,
                    textColor: DeasyColor.kpYellow500,
                    borderColor: DeasyColor.kpYellow500,
                    primary: DeasyColor.neutral000,
                    paddingButton: 12,
