...
OptimusResponseGetDetailRoleManagement responseGetDetailRoleManagementFromJson(String str) => OptimusResponseGetDetailRoleManagement.fromJson(json.decode(str));

String responseGetDetailRoleManagementToJson(OptimusResponseGetDetailRoleManagement data) => json.encode(data.toJson());

class OptimusResponseGetDetailRoleManagement {
  OptimusResponseGetDetailRoleManagement({
    this.code,
    this.message,
    this.data,
    this.errors,
  ...
  factory OptimusResponseGetDetailRoleManagement.fromJson(Map<String, dynamic> json) => OptimusResponseGetDetailRoleManagement(
