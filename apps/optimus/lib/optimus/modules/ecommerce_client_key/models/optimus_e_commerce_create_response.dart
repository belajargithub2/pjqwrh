class OptimusECommerceClientKeyCreateResponse {
  String? message;
  Data? data;

  OptimusECommerceClientKeyCreateResponse({this.message, this.data});

  OptimusECommerceClientKeyCreateResponse.fromJson(Map<String, dynamic> json) {
