...
class OptimusNewPasswordMobile extends GetView<OptimusNewPasswordController> {
  @override
      ...
      children: [
                    ...
                    children: [
                      ...
                      FadeInAnimation(
                        ...
                        child: Obx(() => DeasyTextForm.outlinedTextForm(
                              ...
                              suffixIcon: Obx(() => GestureDetector(
                                    child: Icon(
                                        controller.isTextObscuredConfirmPassword
                                                .isFalse
                                            ? Icons.visibility_off_outlined
                                            : Icons.visibility_outlined,
                                        color: DeasyColor.neutral600,
        ...
        Obx(
          () => Visibility(
            ...
            child: DeasyFullScreenLoading(messageLoading: "Mohon menunggu..."),
          ),
        ),
      ],
    );
