...
class FilterMerchantBoxWidget extends GetWidget<DashboardMainController> {
  @override
  Widget build(BuildContext context) {
    return Obx(
      () => Visibility(
        visible: controller.isMerchantSearchBoxTapped.isTrue,
        child: Positioned(
          top: 50,
          right: 0,
          child: Container(
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: PagedListView<int, DashboardSearchMerchantData>(
                        pagingController:
                            controller.searchMerchantPagingController,
