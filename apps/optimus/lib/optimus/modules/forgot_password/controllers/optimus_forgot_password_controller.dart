...
class OptimusForgotPasswordController extends GetxController {
  ...
  final isShowDialogWebsite = false.obs;
  ...
  String? validateEmail(String text) {
    ...
    if (!text.isEmailAddress()) {
      return ValidationConstant.emailNotValid;
    }
  }
}
