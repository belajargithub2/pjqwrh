...
import 'package:kreditplus_deasy_website/optimus/modules/login/views/widgets/login_phone/step_2/optimus_request_otp_container_widget.dart';
import 'package:kreditplus_deasy_website/core/constant/constants.dart';
import 'package:kreditplus_deasy_website/core/widgets/wave_sidebar.dart';

class OptimusRequestOtpPage
            ...
            if (screenType == DeasyScreenType.desktop) {
              return Row(
                children: [
                  ...
                  Expanded(flex: 7, child: OptimusRequestOtpContainerWidget()),
                ],
              );
            }
            ...
            return Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  OptimusRequestOtpContainerWidget()
                ],
              ),
            );
          },
