abstract class ContentConstant {
  ...
  static String get checkEmailInbox1 => 'Periksa kotak masuk email Anda.';

  static String get checkEmailInbox2 => 'Kami telah mengirimkan tautan verifikasi untuk mengatur';

  static String get checkEmailInbox3 => 'kata sandi ke';
  ...
  static String get resendOtp => 'Kirim Ulang';
  ...
  static String get dialogConfirmSubTitle =>
      'Apakah kamu yakin untuk memproses penghapusan akun?';

  static String get dialogBtnDelete => 'Hapus';

  static String get dialogBtnCancel => 'Batal';

  static String get dialogBtnApply => 'Terapkan';

  static String get dialogBtnOke => 'Oke';

  static String get dialogBtnOk => 'Ok';

  static String get dialogEmailAnnouncementTitle => 'Konfirmasi via Email';

  static String get dialogEmailAnnouncementSubTitle =>
      'Klik direct link yang sudah kami kirimkan ke email-mu untuk melanjutkan proses hapus akun';

  static String get dialogReminderToConfirmByEmailTitle =>
      'Konfirmasi Penghapusan Akun via Email';

  static String get dialogReminderToConfirmByEmailSubTitle =>
      'Kamu belum mengkonfirmasi penghapusan akun-mu. Silahkan klik direct link yang sudah kami kirimkan ke email-mu untuk melanjutkan proses hapus akun';

  static String get dialogDeleteAccountSuccessTitle =>
      'Penghapusan akun Berhasil';

  static String get dialogDeleteAccountSuccessSubTitle =>
  ...
  static String get successAddRole => 'Role baru telah berhasil ditambahkan.';

  static String get successUpdateRole => 'Role berhasil diubah.';
  ...
  static String get sideItemMerchantUserManagement =>
      'Merchant User Management';

  static String get submission => 'Pengajuan';
  ...
  //Login phone
  static String get phoneTextFieldLabel => 'Nomor Handphone';

  static String get phoneTextFieldHint => 'Masukan Nomor Handphone';
  static const String loggingIn = 'Masuk';
  static const String chooseOtpTypeWording1 =
      'Demi keamanan akun anda, mohon dilakukan proses verifikasi akun anda.';

  static const String chooseOtpTypeWording2 =
      'Pilih satu metode untuk pengiriman kode verifikasi (OTP) ke';

  static const String otpVerificationWording =
      'Kami akan melakukan panggilan ke nomor kamu. Panggilan ini tidak perlu dijawab';

  static const String sendMissedCallMethod = 'Kirim Melalui Panggilan';
  static const String sendSmsMethod = 'Kirim Melalui SMS';
  static const String otpVerification = 'Verifikasi Kode OTP';
  static const String important = 'PENTING!';
  static const String important1 =
      'Kode OTP kamu adalah 6 digit terakhir dari nomor yang akan menelepon kamu';
  static const String important2 =
      "Pastikan nomor kamu dapat menerima panggilan";
  static const String important3 =
      'Jangan beritahu nomor tersebut pada siapapun';
  static const String callMe = 'Hubungi Saya';
  static const String otpMissedCallInputWording =
      'Silakan lanjutkan dengan mengisi 6 digit terakhir dari nomor yang menelepon kamu';
  static const String otpSmsInputWording =
      'Isi dengan kode OTP yang telah kami kirimkan melalui SMS ke nomor';
  static const String phoneNumberWrong = 'Nomor handphone keliru?';
  ...
  static const String otpNotReceive = 'Tidak menerima kode OTP?';
  static const String resendOtpCode = 'Kirim Ulang OTP';
  static const String SMSOTP = 'SMS';
  static const String MISSCALLOTP = 'MISSCALL';
  ...
  static const String deasyWelcomeTab = "Selamat Datang\ndi DEASY!";
  static const String deasyWelcomeDesktop = "Selamat Datang di DEASY!";
  static const String chooseOtpMethod = "Pilih Metode Pengiriman Kode OTP";

  //automail
  static const String automail = 'Automail';
  static const String sideSubItemSettingsAutomail = 'Automail';
  static const String automailChange = 'Ubah';
  static const String automailDetail = 'Detail';
  static const String automailReceive = 'Terima Automail';
  static const String automailRecipientType = 'Tipe Penerima';
  static const String automailChooseRecipientType = 'Pilih Type Penerima';
  static const String automailRecipient = 'Penerima';
  static const String automailDetailRecipient = 'Detail Penerima';
  static const String automailTambahlRecipient = 'Tambah Penerima';
  static const String automailRecipientsForm = 'Penerima Automail';
  static const String automailRecipients1 = 'Penerima 1';
  static const String automailRecipients2 = 'Penerima 2';
  static const String automailRecipients3 = 'Penerima 3';
  static const String automailDealer = 'Dealer';
  static const String automailTypeCantBeEmpty =
      'Tipe Penerima tidak boleh kosong';
  static const String automailDealerCantBeEmpty = 'Dealer tidak boleh kosong';
  static const String automailFirstEmailCantBeEmpty =
      'Penerima 1 tidak boleh kosong';
  static const String automailDealerHasBeenRegistered =
      'Dealer ini sudah terdaftar pada daftar penerima automail';
  static const String automailRecipientSaved = 'Penerima Berhasil Disimpan';
  static const String automailEnable = 'Automail berhasil diaktifkan';
  static const String automailDisable = 'Automail berhasil dimatikan';
  static const String automailDisableTitle = 'Matikan Automail?';
  static const String automailDisableSubTitle =
      'penerima automail tidak akan mendapatkan email';
  static const String automailEnableTitle = 'Aktifkan Automail?';
  static const String automailEnableSubTitle =
      'penerima automail akan mendapatkan email';
  static const String automailSaveTitle = 'Simpan Penerima?';
  static const String automailSaveSubTitle =
      'Pastikan email penerima Automail sudah tepat';
  static const String automailAddRecipient = "Tambah Penerima";

  //table-pagination
  static const String tablePaginationEmpty = "Showing 0 to 0 entries";

  // merchant user management feature
  static const String merchantUserManagementInfo =
      "Maksimal Merchant Employee yang dapat ditambahkan adalah 3 Employee";
  static const String addMerchantUser = "Tambah";
  static const String merchantUserManagementTableNo = "No";
  static const String merchantUserManagementTableUserName = "User Name";
  static const String merchantUserManagementTablePhoneNumber = "Phone Number";
  static const String merchantUserManagementTableEmail = "Email";
  static const String merchantUserManagementTableStatus = "Status";
  static const String merchantUserManagementTableUpdateAt =
      "Terakhir diperbarui";
  static const String merchantUserManagementTableAction = "Aksi";

  static String get deaLobType => 'dea';

  static String get electronicLobName => 'elektronik';

  static String get msgNameMaxLength =>
  ...
  static String get waiting => 'Permintaan kirim email melebihi batas. Silakan coba kembali setelah 15 menit';
