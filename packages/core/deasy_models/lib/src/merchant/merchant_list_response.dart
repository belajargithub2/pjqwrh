...
import 'package:deasy_models/src/merchant/source_app_response.dart';
...
class MerchantListResponse {
  ...
  factory MerchantListResponse.fromJson(Map<String, dynamic> json) => MerchantListResponse(
    ...
    pageInfo: json["page_info"] == null ? null : MerchantListPageInfo.fromJson(json["page_info"]),
  );
...
class MerchantListPageInfo {
  MerchantListPageInfo({
    this.totalRecord,
    this.totalPage,
    this.offset,
    this.limit,
  ...
  factory MerchantListPageInfo.fromJson(Map<String, dynamic> json) => MerchantListPageInfo(
