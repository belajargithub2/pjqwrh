class SourceAppResponse {
  List<SourceAppData>? listSourceAppData;
  String? message;
  SourceAppPageInfo? pageInfo;

  SourceAppResponse({this.listSourceAppData, this.message});

  SourceAppResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
    ...
    pageInfo = json['page_info'] != null
        ? new SourceAppPageInfo.fromJson(json['page_info'])
        : null;
  }
...
class SourceAppPageInfo {
  ...
  SourceAppPageInfo.fromJson(Map<String, dynamic> json) {
    limit = json['limit'];
