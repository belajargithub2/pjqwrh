...
const Map<String, EnumOrderTransaction> ResponseEnumOrderTransactionMap = {
  ...
  'BI Checking': EnumOrderTransaction.biChecking,
  'Credit Process': EnumOrderTransaction.creditProcess,
  'Survey': EnumOrderTransaction.survey,
};
...
extension EnumOrderTransactionExtension on EnumOrderTransaction? {
  ...
  String get message {
    switch (this) {
      ...
      case EnumOrderTransaction.biChecking:
        return 'Status “BI Checking” menandakan bahwa form baru saja diajukan dan sedang diproses.';
      case EnumOrderTransaction.creditProcess:
        return 'Status “Proses Kredit” menandakan bahwa form baru saja diajukan dan sedang diproses.';
     case EnumOrderTransaction.survey:
        return 'Status “Survey” menandakan bahwa form baru saja diajukan dan sedang diproses.';
      default:
        return "";
    }
  }
