...
class NotificationListResponse {
  ...
  NotificationListPageInfo? pageInfo;
  ...
  factory NotificationListResponse.fromJson(Map<String, dynamic> json) => NotificationListResponse(
    ...
    pageInfo: json["page_info"] == null ? null : NotificationListPageInfo.fromJson(json["page_info"]),
  );
...
class NotificationListPageInfo {
  ...
  factory NotificationListPageInfo.fromJson(Map<String, dynamic> json) => NotificationListPageInfo(
