...
class DetailAgentOrderResponse {
  ...
  int? code;
  String? message;
  DetailAgentOrderData? data;

  factory DetailAgentOrderResponse.fromJson(Map<String, dynamic> json) => DetailAgentOrderResponse(
    code: json["code"] == null ? null : json["code"],
    message: json["message"] == null ? null : json["message"],
    data: json["data"] == null ? null : DetailAgentOrderData.fromJson(json["data"]),
  );
}

class DetailAgentOrderData {
  DetailAgentOrderData({
    this.prospectId,
    this.customerName,
    this.orderDate,
    this.legalName,
  ...
  factory DetailAgentOrderData.fromJson(Map<String, dynamic> json) => DetailAgentOrderData(
