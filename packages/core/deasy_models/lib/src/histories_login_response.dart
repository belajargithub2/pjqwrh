...
HistoriesLoginResponse historiesLoginResponseFromJson(String str) => HistoriesLoginResponse.fromJson(json.decode(str));

String historiesLoginResponseToJson(HistoriesLoginResponse data) => json.encode(data.toJson());

class HistoriesLoginResponse {
  HistoriesLoginResponse({
    this.code,
    this.data,
    this.error,
    this.errors,
  ...
  int? code;
  HistoriesLoginData? data;
  String? error;
  String? errors;
  String? message;
  HistoriesLoginPageInfo? pageInfo;

  factory HistoriesLoginResponse.fromJson(Map<String, dynamic> json) => HistoriesLoginResponse(
    code: json["code"] == null ? null : json["code"],
    data: json["data"] == null ? null : HistoriesLoginData.fromJson(json["data"]),
    error: json["error"] == null ? null : json["error"],
    errors: json["errors"] == null ? null : json["errors"],
    message: json["message"] == null ? null : json["message"],
    pageInfo: json["page_info"] == null ? null : HistoriesLoginPageInfo.fromJson(json["page_info"]),
  );
...
class HistoriesLoginData {
  ...
  factory HistoriesLoginData.fromJson(Map<String, dynamic> json) => HistoriesLoginData(
...
class HistoriesLoginPageInfo {
  HistoriesLoginPageInfo({
    this.limit,
    this.nextPage,
    this.offset,
    this.page,
  ...
  factory HistoriesLoginPageInfo.fromJson(Map<String, dynamic> json) => HistoriesLoginPageInfo(
