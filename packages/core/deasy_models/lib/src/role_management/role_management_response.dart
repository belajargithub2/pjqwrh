...
RoleManagementResponse responseGetAllRoleFromJson(String str) => RoleManagementResponse.fromJson(json.decode(str));

String responseGetAllRoleToJson(RoleManagementResponse data) => json.encode(data.toJson());
...
class RoleManagementResponse {
  ...
  RoleManagementPageInfo? pageInfo;

  factory RoleManagementResponse.fromJson(Map<String, dynamic> json) => RoleManagementResponse(
    code: json["code"] == null ? null : json["code"],
    message: json["message"] == null ? null : json["message"],
    data: json["data"] == null ? null : List<RoleManagementData>.from(json["data"].map((x) => RoleManagementData.fromJson(x))),
    pageInfo: json["page_info"] == null ? null : RoleManagementPageInfo.fromJson(json["page_info"]),
  );
...
class RoleManagementPageInfo {
  RoleManagementPageInfo({
    this.totalRecord,
    this.totalPage,
    this.offset,
    this.limit,
  ...
  factory RoleManagementPageInfo.fromJson(Map<String, dynamic> json) => RoleManagementPageInfo(
