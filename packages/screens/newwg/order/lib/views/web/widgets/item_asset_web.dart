...
class ItemAssetWeb extends GetWidget<OrderController> {
  final int? index;
    ...
    return Obx(() => Visibility(
        ...
        child: Row(
          ...
          children: [
            ...
            ClipOval(
              child: Material(
                color: controller.listAsset[index!].qty! < 2
                    ...
                    : DeasyColor.kpYellow500, // Button color
                child: InkWell(
            ...
            ClipOval(
              child: Material(
                color: DeasyColor.kpYellow500, // Button color
                child: InkWell(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                flex: 3,
                child: Obx(
                      () => controller.isEmptyProduct.isFalse
                          ? OrderPagination(
